...
export default defineConfig({
  ...
  plugins: [{name:'extension-package',closeBundle(){
    ...
    for(const file of ['manifest.json','background.js','autofill-content.js','README-BN.md','city-logo.png','agent-user-id-seal.jpg'])copyFileSync(`chrome-extension/${file}`,`${out}/${file}`);
