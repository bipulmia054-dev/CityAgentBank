# Chrome Extension 2.4.2 — eKYC Autofill

## নতুন Auto Fill ব্যবহার

1. Website update deploy করার পরে Admin → Applications → A–Z Preview & Edit খুলুন। AI Process চাপলে স্পষ্ট পাওয়া তথ্য form-এ বসে Auto-save হবে। প্রয়োজন হলে সরাসরি edit করুন। Risk-এর customer-specific উত্তর লিখুন; আলাদা verification checkbox নেই। অজানা উত্তর default হিসেবে সত্য ধরা হয় না।
2. নতুন ZIP extract করে Chrome Extensions-এ ওই `chrome-extension` folder Load unpacked করুন। পুরোনো folder ব্যবহার করলে নতুন ফাইল সেখানে বসিয়ে Reload করুন। Version 2.4.2 নিশ্চিত করুন। Bank domain-এর permission Chrome চাইলে নিজে review/allow করুন।
